...
@WebServlet(name = "Encrypt", value = "/encrypt")
@MultipartConfig
public class EncryptHttpServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(!filePart.getSubmittedFileName().isEmpty()) {
            ...
            try(FileReader fileReader = new FileReader(pathToFile);
                ...
                while(reader.ready()) {
                    ...
                    writer.write(Crypto.encryptByKey(str, key));
                    writer.newLine();
        ...
        String encryptedMessage = Crypto.encryptByKey(message, key);
